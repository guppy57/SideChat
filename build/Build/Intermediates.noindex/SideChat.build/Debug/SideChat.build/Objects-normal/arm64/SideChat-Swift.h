...
#ifndef SIDECHAT_SWIFT_H
#define SIDECHAT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SideChat",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8SideChat11AppDelegate")
...
SWIFT_CLASS("_TtC8SideChat13EdgeTabWindow")
@interface EdgeTabWindow : NSWindow
...
SWIFT_CLASS("_TtC8SideChat13SidebarWindow")
@interface SidebarWindow : NSWindow
- (nonnull instancetype)initWithContentRect:(NSRect)contentRect styleMask:(NSWindowStyleMask)style backing:(NSBackingStoreType)backingStoreType defer:(BOOL)flag OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly) BOOL canBecomeKeyWindow;
@property (nonatomic, readonly) BOOL canBecomeMainWindow;
- (void)awakeFromNib;
